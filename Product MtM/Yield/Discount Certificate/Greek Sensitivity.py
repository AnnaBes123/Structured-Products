...
# T and CAP fixed throughout; only spot varies below.
...
# GREEKS LADDER: T and CAP fixed; only spot varies. Theta excluded (T never
# moves). See README "Reading the charts".
